      ...
      <div className={`dashboard-content ${sidebarExpanded ? 'sidebar-expanded' : 'sidebar-collapsed'}`}>
        ...
        <div style={{ 
          ...
          <div className="coming-soon-card">
            ...
            <h1>Headcount</h1>
            <p>Employee headcount and workforce analytics dashboard is currently under development.</p>
            <div className="features-list">
              <div className="feature-item">👥 Staff Count</div>
              <div className="feature-item">📊 Department Analysis</div>
              <div className="feature-item">📈 Growth Tracking</div>
              <div className="feature-item">🎯 Resource Planning</div>
            </div>
