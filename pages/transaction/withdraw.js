      ...
      <div className={`dashboard-content ${sidebarExpanded ? 'sidebar-expanded' : 'sidebar-collapsed'}`}>
        ...
        <div style={{ 
          ...
          <div className="coming-soon-card">
            ...
            <h1>Withdraw</h1>
            <p>Withdrawal transaction analytics and monitoring dashboard is currently under development.</p>
            <div className="features-list">
              <div className="feature-item">💸 Withdrawal Analytics</div>
              <div className="feature-item">📊 Transaction Monitoring</div>
              <div className="feature-item">📈 Performance Tracking</div>
              <div className="feature-item">🔍 Risk Analysis</div>
            </div>
