...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('📊 Fetching new_depositor data with filters:', { currency, line, year, month, startDate, endDate, filterMode, page, limit });
    ...
    console.log(`✅ Found ${result.rows.length} records from new_depositor (Page ${page} of ${Math.ceil(totalRecords / parseInt(limit))})`);
    ...
    console.error('❌ Error fetching new_depositor data:', error);
    res.status(500).json({ 
      success: false,
