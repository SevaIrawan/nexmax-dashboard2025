...
export default function BGO() {
  const { user, loading: authLoading } = useRoleAccess('/bgo');
      ...
      <div className={`dashboard-content ${sidebarExpanded ? 'sidebar-expanded' : 'sidebar-collapsed'}`}>
        ...
        <div style={{ 
          ...
          <div className="coming-soon-card">
            ...
            <h1>BGO</h1>
            <p>Business Growth Operations dashboard is currently under development.</p>
            <div className="features-list">
              <div className="feature-item">🚀 Growth Analytics</div>
              <div className="feature-item">📊 Performance Metrics</div>
              <div className="feature-item">🎯 KPI Tracking</div>
              <div className="feature-item">💡 Business Insights</div>
            </div>
